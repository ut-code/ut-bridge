    ...
    <>
      ...
      <div className="m-5">
        <Link href={"/settings/basic"} className={`block ${
          pathname === "/settings/basic" ? "font-bold underline" : ""
        }`}>
          基本情報
        </Link>
        <Link href={"/settings/university"} className={`block ${
          pathname === "/settings/university" ? "font-bold underline" : ""
        }`}>
          大学情報
        </Link>
        <Link href={"/settings/language"} className={`block ${
          pathname === "/settings/language" ? "font-bold underline" : ""
        }`}>
          言語情報
        </Link>
        <Link href={"/settings/topic"} className={`block ${
          pathname === "/settings/topic" ? "font-bold underline" : ""
        }`}>
          トピック
        </Link>
