    ...
    <>
      ...
      <div className="m-5 mt-15 flex flex-col gap-0.5 border-gray-300">
        <Link
          ...
          className="flex items-center justify-between rounded-t-xl bg-neutral-50 p-4 px-8 text-xl"
        >
          プライバシーポリシー
        ...
        <Link
          ...
          className="flex items-center justify-between rounded-b-xl bg-neutral-50 p-4 px-8 text-xl"
        >
          利用規約
          <ChevronRight className="sm:hidden" />
        </Link>
